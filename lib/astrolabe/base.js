...
Base.prototype = Object.create({}, {
    ...
    findElement: { writable: false, enumerable: false, value: function(by) { return this.context.findElement(by); } },
    findElements: { writable: false, enumerable: false, value: function(by) { return this.context.findElements(by); } }
});
