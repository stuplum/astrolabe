...
Base.prototype = Object.create({}, {
    ...
    find: {
        get: function() {
            ...
            var allBys = {
                id: function (selector) { return base.findAllBy(base.by.id, selector); },
                css: function (selector) { return base.findAllBy(base.by.css, selector); },
                xpath: function (selector) { return base.findAllBy(base.by.xpath, selector); },
                name: function (selector) { return base.findAllBy(base.by.name, selector); },
                tagName: function (selector) { return base.findAllBy(base.by.tagName, selector); },
                className: function (selector) { return base.findAllBy(base.by.className, selector); },
                linkText: function (selector) { return base.findAllBy(base.by.linkText, selector); },
                partialLinkText: function (selector) { return base.findAllBy(base.by.partialLinkText, selector); },
                js: function (selector) { return base.findAllBy(base.by.js, selector); },
                binding: function (selector) { return base.findAllBy(base.by.binding, selector); },
                select: function (selector) { return base.findAllBy(base.by.select, selector); },
                selectedOption: function (selector) { return base.findAllBy(base.by.selectedOption, selector); },
                input: function (selector) { return base.findAllBy(base.by.input, selector); },
                model: function (selector) { return base.findAllBy(base.by.model, selector); },
                textarea: function (selector) { return base.findAllBy(base.by.textarea, selector); },
                repeater: function (selector) { return base.findAllBy(base.by.repeater, selector); },
                buttonText: function (selector) { return base.findAllBy(base.by.buttonText, selector); },
                partialButtonText: function (selector) { return base.findAllBy(base.by.partialButtonText, selector); },
            };
